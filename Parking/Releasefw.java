...
import javax.swing.*;
import java.sql.*;
public class Releasefw extends JFrame
{
	
	static JLabel l1,l2,l3;
	static JTextField t1,t2;
	static JButton b1;
	static JFrame f=new JFrame("Four Wheeler Release Parking Slot");
	
	
	public static void Releasefourwheeler()
	{


		
		l2=new JLabel("Release 4-Wheeler Parking Slot");
		...
		public void actionPerformed(ActionEvent ae)
			{
				try
				{
					...
					String qry="update Block set status='empty' where Bid=? and Sno=? and Btype='Four Wheeler'";
